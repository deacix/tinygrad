...
class TestPlacedLoading:
  ...
  # v0.14.0's dequantizer has no Q2_K (10) or Q3_K (11), so the index refuses them before placement preflight.
  @pytest.mark.parametrize('typ,size,match', [(3,20,'unsupported placed GGML type'),(6,22,'unsupported placed GGML type'),
                                              (7,24,'unsupported placed GGML type'),(10,84,'Unknown GGML tensor type'),
                                              (11,110,'Unknown GGML tensor type'),(26,128,'unsupported placed GGML type'),
                                              (28,256,'unsupported placed GGML type')])
  def test_known_but_unaccepted_formats(self, tmp_path, typ, size, match):
